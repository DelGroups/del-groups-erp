-- Extended product metadata: brand, country of origin, manufacturing / expiry dates.
...
BEGIN
  ...
  VALUES (
    ...
    NULLIF(btrim(p_product->>'country_of_origin'), ''),
    NULLIF(p_product->>'mfg_date', '')::date,
    NULLIF(p_product->>'exp_date', '')::date
  )
