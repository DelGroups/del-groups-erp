-- Journal engine prerequisites: chart_of_accounts + resolve_coa_id
-- Required by post_cash_transaction (advance payments) and post_journal_entry (COGS/revenue)
...
VALUES
  ...
  ('1350', 'WIP / İstehsalat inventarı', 'asset'),
...
GRANT EXECUTE ON FUNCTION public.resolve_coa_id(TEXT) TO authenticated, service_role;
