...
ALTER TABLE sales ADD COLUMN IF NOT EXISTS status TEXT DEFAULT 'draft';
...
ALTER TABLE sales ADD COLUMN IF NOT EXISTS currency TEXT DEFAULT 'AZN';
ALTER TABLE sales ADD COLUMN IF NOT EXISTS exchange_rate NUMERIC DEFAULT 1;
ALTER TABLE sales ADD COLUMN IF NOT EXISTS posted_at TIMESTAMPTZ;
